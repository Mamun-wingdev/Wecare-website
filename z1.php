...
if(isset($_POST['submit'])){      
		...
		$insert= mysqli_query($connection,"INSERT INTO wants (name,address,date,time,contact,type) VALUES ('$name','$address','$date','$time','$no','homeworker')");
...
<body>
 ...
 <!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      <!-- Indicators -->
      <h1  style="background:#9E9999; color:#F5EDED; font-size:60px"><center>কাজের বুয়া</center></h1>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="bangladesh-factory-safety.jpg" alt="First slide"  style="height:500px; width:100%">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="garment-workers.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
           ...
           <div class="item">
          <img class="second-slide" src="international-labor-rights-forum-our-voices-safety-1-537x403.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="garment_factory.jpg.size.xxlarge.letterbox.jpg" alt="Third slide" style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
...
<div class="row">
<form action="z1.php" method="post" onSubmit="return check()">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p>
<p>
•	কাজের বুয়ার সার্ভিস চার্জ ঃ <br>
১। প্রতিদিন কাজের ভিত্তিতে কাজের বুয়া ঃ ২৫ টাকা । প্রতিদিন কাজ শেষে টাকা পরিশোধ করতে হবে<br>
২। মাসিক কাজের বুয়া ঃ ৭০০ টাকা প্রতি কাজ । মাস শেষে পরিশোধ করতে হবে<br>
৩। স্থায়ী বুয়া ঃ ৩০০০ টাকা । মাস শেষে পরিশোধ করতে হবে<br>
