...
if(isset($_POST['submit'])){      
		...
		$insert= mysqli_query($connection,"INSERT INTO wants (name,address,date,time,contact,type) VALUES ('$name','$address','$date','$time','$no','guard')");
...
<body>
 ...
 <!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      <!-- Indicators -->
      <h1 style="background:#9E9999; color:#F5EDED; font-size:60px"><center>গার্ড</center></h1>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="50958487.jpg" alt="First slide"  style="height:500px; width:100%">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="4370909100_68db542ff7.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
           ...
           <div class="item">
          <img class="second-slide" src="12473784784_3eafbefe02_b.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="hqdefault.jpg" alt="Third slide" style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
...
<div class="row">
<form action="z4.php" method="post" onSubmit="return check()">
