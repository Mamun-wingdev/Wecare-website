...
if(isset($_POST['submit'])){      
		...
		$insert= mysqli_query($connection,"INSERT INTO wants (name,address,date,time,contact,type) VALUES ('$name','$address','$date','$time','$no','network')");
...
<body>
 ...
 <!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      <!-- Indicators -->
      <h1 style="background:#9E9999; color:#F5EDED; font-size:60px"><center>ইন্টারনেট সেবা</center></h1>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="Broadband Wireless Access .jpg" alt="First slide"  style="height:500px; width:100%">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="abangladeshi.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
           ...
           <div class="item">
          <img class="second-slide" src="internet-flickr-by-photosteve101-1024x768.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
           ...
           <div class="item">
          <img class="second-slide" src="wallpaper-770699.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="38848.jpg" alt="Third slide" style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
...
<div class="row">
<form action="z3.php" method="post" onSubmit="return check()">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p>এক প্ল্যাটফর্ম , সম্পূর্ণ আইটি সেবা
আমাদের মিশন  দক্ষ  ও প্রশিক্ষিত আইটি পেশাদারদের প্রদান করা হয়
ডিজাইন এবং বৈশ্বিক অর্থনৈতিক সম্প্রদায়ের জন্য প্রয়োজনীয় নির্মিত ,  পরিষেবার গতি এবং নির্ভরযোগ্যতা জন্য মান সেট , সব সম্পত্তির ক্লাস এবং বাণিজ্য চক্র ব্যবসা ফাংশন জুড়ে 400  সেবা প্রদানকারীর অ্যাক্সেস বিশ্বের সর্ববৃহৎ নিরাপদ নেটওয়ার্ক আর্থিক সম্প্রদায়ের সমর্থনের উপর 15,000 ব্যবহারকারী অবস্থানের .<br>
.

সেবাসমূহ<br>

•	স্বয়ংক্রিয় আবিষ্কার<br>
•	প্যাচ ও এন্টি ভাইরাস স্থাপন<br>
•	ব্যাক-আপ<br>
...
•	নির্ভরযোগ্য বিজ্ঞপ্তি<br>
•	অটোমেটেড রক্ষণাবেক্ষণ<br>
•	দ্রুত প্রতিবেদন এবং সমাধান<br>

পৃষ্ঠপোষকতা <br>
•	ডিভাইসের সমস্যার সমাধান<br>
•	সমস্যা সমাধান<br>
