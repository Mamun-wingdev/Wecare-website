...
?>
<?php
$query= "select * from wants where type='electrician'";             
...
<h1 style="text-decoration:underline"><center>ইলেক্টিসিয়ান এর গ্রাহক সমূহঃ</center></h1>
...
?>
 ...
 <center> Serial no: <?php echo $a; ?><br><br></center>
  NAME:     <?php	echo $subject["name"];  $_SESSION["name5"] = $subject["name"];?> <br>  <br> 
