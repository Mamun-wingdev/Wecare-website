...
if(isset($_POST['submit'])){      
		...
		$insert= mysqli_query($connection,"INSERT INTO wants (name,address,date,time,contact,type) VALUES ('$name','$address','$date','$time','$no','electrician')");
...
<body>
 ...
 <!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      <!-- Indicators -->
      <h1 style="background:#9E9999; color:#F5EDED; font-size:60px"><center>ইলেক্ট্রেসিয়ান</center></h1>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="&NCS_modified=20131226201333&MaxW=640&imageVersion=default&AR-131229426.jpg" alt="First slide"  style="height:500px; width:100%">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="maxresdefault.jpg" alt="Second slide"  style="height:500px; width:100%">
          <div class="container">
            <div class="carousel-caption">
...
<div class="row">
<form action="z6.php" method="post" onSubmit="return check()">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      <p id="345" style="display:none; color:#F81216">অবশ্যই আপনার নেশনাল আইডি কার্ড নাম দিন।</p>
    </div>
